...
(function($) {
    ...
    FTEMP.head = {
        ...
        navScroller: function() {
            $singlePageNav.find('li').removeClass('current');
            $singlePageNav.find('a[data-href="#' + FTEMP.head.singlePageNavCurrentSection() + '"]').parent('li').addClass('current');
        },
                ...
                $("#portfolio .portfolio-expand-wrap").click(function() {
                    if ($(this).hasClass("active"));
                        ...
                        $("#portfolio-page-data").animate({
                            ...
                            $("#project-page-data").fadeIn("slow", function() {}), $(".fade-in").each(function() {
    ...
    FTEMP.isMobile = {
        ...
        any: function() {
            return (FTEMP.isMobile.Android() || FTEMP.isMobile.BlackBerry() || FTEMP.isMobile.iOS() || FTEMP.isMobile.Opera() || FTEMP.isMobile.Windows());
        }
    };
